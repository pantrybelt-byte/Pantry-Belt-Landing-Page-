        ...
        <div className="space-y-10">
          <div className="p-8 rounded-2xl bg-[#f5f5f7] border border-[#0071e3]/10">
            ...
            <p className="mt-4 text-[#86868b] leading-relaxed">
              Any information you provide, including your name, email, and phone number, is strictly used to send you internal AccessBelt emails, newsletters, and critical app updates. Your privacy is paramount.
            </p>
          </div>
          ...
          <section className="space-y-4">
            ...
            <p className="text-[#86868b] leading-relaxed">
              The data we collect is utilized exclusively for direct communication from the AccessBelt team. We use your contact information to:
            </p>
            <ul className="list-disc pl-6 text-[#86868b] space-y-2">
              <li>Send you updates on when AccessBelt will launch in your area.</li>
          ...
          <section className="space-y-4">
            ...
            <p className="text-[#86868b] leading-relaxed">
              We implement industry-standard security protocols to protect your personal information. Our databases are encrypted, and access is strictly limited to authorized AccessBelt personnel.
            </p>
          </section>
