...
export default function BrandStory() {
  return (
    <section className="section-padding bg-[#f5f5f7] overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-[4/5] rounded-[48px] overflow-hidden shadow-3xl bg-gray-200">
              <img 
            ...
            <motion.div 
              ...
              className="absolute -bottom-10 -right-10 w-56 h-56 bg-white rounded-[40px] shadow-2xl p-10 flex flex-col justify-center border border-gray-100"
            >
              <p className="text-4xl font-display font-bold text-blue-600 mb-1">100%</p>
              <p className="text-xs font-bold text-gray-400 uppercase tracking-widest leading-tight">Community <br />Focused</p>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="space-y-4">
              <h2 className="text-blue-600">Our Brand Story</h2>
            ...
            <div className="pt-8 border-t border-gray-200">
              <div className="flex items-center gap-5">
                <div className="flex -space-x-4">
                  <div className="w-14 h-14 rounded-full bg-gray-200 overflow-hidden ring-4 ring-white shadow-sm relative z-10">
                    <img src="https://picsum.photos/seed/matthew/100/100" alt="Matthew Clarke" referrerPolicy="no-referrer" />
                  </div>
                  <div className="w-14 h-14 rounded-full bg-gray-200 overflow-hidden ring-4 ring-white shadow-sm relative z-0">
                ...
                <div>
                  ...
                  <p className="text-apple-gray text-sm font-medium uppercase tracking-wider">Founders, Pantry Belt</p>
                </div>
              </div>
            </div>
          </motion.div>
