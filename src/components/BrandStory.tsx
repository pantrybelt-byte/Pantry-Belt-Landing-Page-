              ...
              >
                ...
                <div className="relative rounded-[44px] overflow-hidden" style={{ aspectRatio: "9/19.5" }}>
                  ...
                  <video
                    ...
                    loop
                    playsInline
                    aria-label="AccessBelt app demo showing the food pantry locator and navigation features"
                    style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }}
                  >
                    <track kind="captions" src="/accessbelt-captions.vtt" srcLang="en" label="English" default />
          ...
          >
            <div className="space-y-4">
              <div className="flex items-center gap-4 mb-2">
                <p className="section-label !mb-0">Our Brand Story</p>
              ...
              <h2 className="text-5xl md:text-6xl font-display font-semibold text-[#1d1d1f] leading-[1.1] tracking-tight">
                Born from a need <br /> to bridge the gap.
              </h2>
            </div>
            
            <div className="space-y-6">
              <p className="text-xl text-[#6e6e73] leading-relaxed font-medium">
            ...
            <div className="pt-8 border-t border-black/5">
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-[#6e6e73] text-sm font-medium uppercase tracking-wider">Founders, AccessBelt</p>
                </div>
              </div>
            </div>
          </motion.div>
