...
exports.onAndroidTesterSignup = exports.onWaitlistSignup = void 0;
const firestore_1 = require("firebase-functions/v2/firestore");
const admin = require("firebase-admin");
admin.initializeApp();
exports.onWaitlistSignup = (0, firestore_1.onDocumentCreated)("waitlist/{docId}", async (event) => {
...
exports.onAndroidTesterSignup = (0, firestore_1.onDocumentCreated)("android_testers/{docId}", async (event) => {
    const snap = event.data;
    if (!snap)
        return;
    const data = snap.data();
